    ...
    roomsList.forEach(room => {
        ...
        const rowHtml = `
            <tr id="room_row_${room.id}">
                <td>
                    <img src="${imageSrc}" alt="${room.roomName || 'Room'}" class="rounded-3 shadow-sm" style="width: 70px; height: 50px; object-fit: cover;" onerror="this.src='https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&w=200&auto=format&fit=crop'">
                </td>
                ...
                <td class="text-center">
                    <div class="btn-group gap-2">
                        <button class="btn btn-sm btn-outline-warning rounded-pill px-3 edit-room-btn" 
                                data-id="${room.id}" 
                                data-bs-toggle="modal" 
                                data-bs-target="#roomModal">
                            <i class="bi bi-pencil-fill me-1"></i>Sửa
                        </button>
                        <button class="btn btn-sm btn-outline-danger rounded-pill px-3 delete-room-btn" 
                                data-id="${room.id}">
